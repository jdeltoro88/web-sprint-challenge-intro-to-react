...
reacts is a library thet allows us to render and use component styles.

1. Describe component state.
data passed by the uuser. we need a way to offload a lot of the state (data) that our apps need to use, from the DOM

1. Describe props.
Propsis a special keyword in React, which stands for properties and is being used for passing data from one component to another.
